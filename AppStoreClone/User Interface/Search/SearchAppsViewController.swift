...
class AppsSearchController: BaseCollectionViewController, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(SearchAppsCell.self, forCellWithReuseIdentifier: cellId)
...
//        fetchITunesApps()
    ...
    fileprivate func fetchITunesApps() {
        AppstoreAPI.shared.fetchApps(searchTerm: "Twitter") { (res, err) in
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! SearchAppsCell
