...
class TodayController: BaseCollectionViewController, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(TodayAppImageDescriptionCell.self, forCellWithReuseIdentifier: TodayItem.CellType.single.rawValue)
...
//            print(appFullscreenBeginOffset)
    ...
    fileprivate func beginAnimationAppFullscreen() {
        UIView.animate(withDuration: 0.7, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.7, options: .curveEaseOut, animations: {
            ...
            self.tabBarController?.tabBar.transform = CGAffineTransform(translationX: 0, y: -200)
