...
class MusicController: BaseCollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    fileprivate func fetchData() {
        let urlString = "https://itunes.apple.com/search?term=\(searchTerm)&limit=20"
        AppstoreAPI.shared.fetchGenericJSONData(urlString: urlString) { (searchResult: SearchResult?, err) in
